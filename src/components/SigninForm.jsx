...
import { setKeepLogin } from '../actions/authActions';
...
export default function SigninForm({ keepLogin, error, signin }) {
  const [state, setState] = React.useState(initialState);
  const dispatch = useDispatch();

  const request = async ({ keyCode }) => {
    ...
    <form>
      <fieldset>
        ...
        <p className="login_state">
          ...
          {state.comment === WRONG_PASSWORD && error !== null
